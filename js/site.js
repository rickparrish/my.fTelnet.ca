...
function ConnectToMyAddressBookEntry(index) {
    ...
    var Proxy = '';
    if (false) { // TODO Check user's settings for proxy
        Proxy = '&Proxy=proxy-us-ga.ftelnet.ca&ProxyPort=1123&ProxyPortSecure=11235'; // TODO Read values from settings
    }
...
function ConnectToGlobalAddressBookEntry(name) {
    switch (name) {
        ...
        case 'LV-426':
            ...
            break;
        case 'Starwars':
            window.open('http://embed.ftelnet.ca/?Hostname=towel.blinkenlights.nl&Port=23&Proxy=proxy-us-ga.ftelnet.ca&ProxyPort=1123&ProxyPortSecure=11235&AutoConnect=true&ConnectionType=telnet&Emulation=ansi-bbs&TopButtons=true&VirtualKeyboard=off');
            break;
        case 'Vertrauen':
